...
<BODY>
	<DIV class="top_div">
		<br /> <br /> <br /> <br />
		<h1 style="text-align: center">内江小说网站登陆</h1>
	</DIV>
	<form action="LoginServlet" method="post">
		<DIV
			...
			<p
				...
				&nbsp;&nbsp;&nbsp;<input type="radio" name="state" value="reader"
					checked />读者 <input type="radio" name="state" value="writter" />作者
				<input type="radio" name="state" value="manager" />管理员
			</p>
			<DIV
				...
				<P style="margin: 0px 35px 20px 45px;">
					<SPAN style="float: left;"><A
						...
						style="float: right;"><A
						style="color: rgb(210, 204, 204); margin-right: 5px;"
						href="AuthorRegister.jsp">作者注册</A><A
						style="color: rgb(210, 204, 204); margin-right: 5px;"
						href="ReaderRegister.jsp">读者注册</A> <A> <input type="submit"
							value="登录"
